...
const reasonsWhy = [
  ...
  },
  {
    ...
    body: [
      ...
      "For full clarity, Essential says, on their Privacy Policy (checked 27/8/2024), they collect: Minecraft UUID, Minecraft & modloader versions, Mod Checksums using MD5, User interfaces the player enters during their session, Cosmetics that players choose to preview, Essential config values (with random A/B testing), Servers you join (if you choose to enable it in privacy settings), and computer specs.",
